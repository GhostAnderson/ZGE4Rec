...
def BPR_train_original(dataset, recommend_model, loss_class, epoch, neg_k=1, w=None):
    ...
    aver_user_loss /= total_batch
    aver_item_loss /= total_batch
    time_info = timer.dict()
    timer.zero()
    return f"total_loss{aver_loss:.3f}-bpr_loss{aver_bpr_loss:.3f}-reg_loss{aver_reg_loss:.3f}-user_zinb_loss{aver_user_loss:.3f}-item_zinb_loss{aver_item_loss:.3f}--{time_info}"
